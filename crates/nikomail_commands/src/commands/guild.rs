...
pub async fn create_button(_interaction: Interaction) -> Result<CommandResponse> {
...
pub async fn blacklist_topic_author(interaction: Interaction) -> Result<CommandResponse> {
	Ok(CommandResponse::Message {
